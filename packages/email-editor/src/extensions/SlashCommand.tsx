  ...
  },
  {
    ...
    command: ({ editor, range }: CommandProps) => {
      editor
        ...
        .setHorizontalRule()
        .insertContent(
          `<unsub data-unsend-component='unsubscribe-footer'><p>You are receiving this email because you opted in via our site.<br/><br/><a href="{{vaultkey_unsubscribe_url}}">Unsubscribe from the list</a></p><br><br><p>Company name,<br/>00 street name<br/>City, State 000000</p></unsub>`
        )
        .run();
    },
  },
